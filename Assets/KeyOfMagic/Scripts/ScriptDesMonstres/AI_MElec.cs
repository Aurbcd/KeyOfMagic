...
public class AI_MElec: MonoBehaviour
{
    ...
    void choixSpell()
    {
        ...
        //CHOIX 2 : Sort
        valeurAleatoire = aleatoire.Next(100);
        if (element.Equals("Electricite") && valeurAleatoire <= 75) //Cas Air
        {
            choix = "iobre";
        }
        if (element.Equals("Electricite") && valeurAleatoire > 75)
        {
            choix = "istaliplo";
        }
